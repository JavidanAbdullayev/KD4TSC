...
# CLASSIFIERS = ['student_alone']  # Uncomment to train only student
...
ALPHA_LIST = [0.3]  # Weight for student loss vs distillation loss
...
PATH_OUT = '/home/jabdullayev/phd/projects/KD-4-TSC_torch/Results_Inception'
